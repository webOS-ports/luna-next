...
#ifndef LUNEOSEXTENDEDSURFACE_H
#define LUNEOSEXTENDEDSURFACE_H
...
#include "qwayland-server-luna-surface-extension.h"
...
class SurfaceExtensionGlobal : public QWaylandCompositorExtensionTemplate<SurfaceExtensionGlobal>, public QtWaylandServer::luneos_surface_extension
{
    Q_OBJECT
public:
...
class ExtendedSurface : public QWaylandCompositorExtensionTemplate<ExtendedSurface>, public QtWaylandServer::luneos_extended_surface
{
    Q_OBJECT
